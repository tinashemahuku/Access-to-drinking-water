...
![Urban vs rural population share](charts/01_urban_rural_population_share.png)
...
![Spread of water-access features](charts/02_feature_spread_boxplot.png)

Per-country detail behind that summary, split by service level:

![National service distribution](charts/03_national_service_distribution.png)
![Urban service distribution](charts/04_urban_service_distribution.png)
![Rural service distribution](charts/05_rural_service_distribution.png)
...
high-income countries average 100% basic access, while low-income
countries average about 63% basic access, with the remainder split
across limited, unimproved, and surface-water use.

![Average water access by income group](charts/06_income_group_chart.png)
...
a direct screenshot of a native chart from that workbook.
...
└── charts/
    ├── 01_urban_rural_population_share.png
    ├── 02_feature_spread_boxplot.png
    ├── 03_national_service_distribution.png
    ├── 04_urban_service_distribution.png
    ├── 05_rural_service_distribution.png
    └── 06_income_group_chart.png
```
